...
try {
    ...
    if(fs.existsSync('/.dockerenv')) {
        ...
        if (child_process.execFileSync('id', ['-u']).toString().trim() === '0') {
            console.log("Running as root in docker container, copy known_hosts to /root/.ssh/known_hosts");
        }
    }
    console.log("copying anyway");
